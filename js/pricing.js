...
const plans_list = [
  {
    ...
    frequency: "per month",
    description:
      "Generate up to 5 personalized playlists per month based on user preferences.",
    features: [
  ...
  },
  {
    ...
    frequency: "per month",
    description:
      "Generate up to 20 personalized playlists per month with advanced customization.",
  ...
  },
  {
    ...
    frequency: "per month",
    description:
      "Unlimited personalized playlists with full customization and additional features.",
    features: [
  ...
  },
  {
    ...
    frequency: "per month",
    description:
      "All the features of the Premium Plan for up to 6 family members.",
  ...
  },
  {
    ...
    description:
      "Custom solutions for businesses to create playlists for events, stores, or work environments.",
    features: [
      "Tailored playlist solutions",
  ...
  },
  {
    ...
    description:
      "Advanced features for large organizations with extensive playlist needs and custom requirements.",
    features: [
      "Additional support",
      "Analytics",
...
function populateProductsList() {
  ...
  plans_list.forEach((plan) => {
    const product_features = plan.features
